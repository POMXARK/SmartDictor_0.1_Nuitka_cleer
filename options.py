...
# voice() # раскомментировать ,чтобы посмотреть имеющиеся голоса (голосовой движок)
...
def set_opt():
    ...
    try:
        opt_1 = {  # 'Голос': voise_name,
            'Минимальная скорость': options[3],
            ...
            'X': options[11],
            'Y': options[12],
            'отступ с краев экрана по ширине': options[14],
            'высота': options[16],
            'h1': options[19],
            's1': options[21],
            'v1': options[23],
        ...
        opt_1 = {  # 'Голос': voise_name,
            ...
            'X': 0,
            'Y': 0,
            'отступ с краев экрана по ширине': 0,
            'высота': 0,
            'h1': 0,
            's1': 0,
            'v1': 0,
    ...
    # random_rate = random.uniform(float(opt_1['Минимальная скорость']),float(opt_1['Максимальная скорость'])) # Скорость произношения
